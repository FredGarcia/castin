...
- **Objectif à partir d’un DEX .docx**
    ...
    - Réaliser un copier-coller rapide et sûr du contenu métier exact

- **Périmètre**
    - Lecture d’un DEX au format .docx
    - Application des règles de reprise définies en tableau (règles 1 à 8)
    - Extraction, nettoyage et structuration du contenu des 23 champs CAST'IN identifiés
